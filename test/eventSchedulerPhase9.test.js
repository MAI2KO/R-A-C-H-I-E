...
test("advance and final custom messages stay isolated in concise reminders", () => {
  ...
  assert.match(advanceJson.description, /18:00 UTC/)
  assert.match(advanceJson.description, /Local time: <t:1786384800:t>/)
  assert.match(advanceJson.description, /Advance @​everyone/)
  assert.equal(advanceJson.fields, undefined)
  assert.doesNotMatch(JSON.stringify(advanceJson), /When|Recurrence|Status:|Alliance message:|2026-08-10/i)
  ...
  assert.match(finalJson.description, /\*\*YOU\*\*/)
  assert.match(finalJson.description, /\*\*Foundry\*\*/)
  assert.match(finalJson.description, /approximately 1 minute/)
  assert.match(finalJson.description, /18:00 UTC/)
  assert.match(finalJson.description, /Local time: <t:1786384800:t>/)
  ...
  assert.match(defaults.description, /^\*\*YOU\*\*\n\*\*Foundry\*\*\nAlpha/)
})
